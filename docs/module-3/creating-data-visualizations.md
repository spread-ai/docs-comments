...
The response returned by the GraphQL query needs to be parsed before it can be used by the Graph widget. This JavaScript code parses the data and returns the nodes and edges that the Graph wuidget uses to visualize the data.
