...
In the previous module we created a viewing application to display `featureVariant` data in a table. In this lesson we will create a dashboard that graphicaly shows the relationship between feature variants and software modules.
